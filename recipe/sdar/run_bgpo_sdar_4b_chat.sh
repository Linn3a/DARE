...
# lmdeploy setting
MODEL_PATH=${model_path:-models/SDAR-4B-Chat}
SERVER_PORT=23333
...
# env variables for ppo training
...
batch_size=7  # batch_size must be greater than the number of GPUs used
n_rollout=8
lr=5e-7
...
python3 -m verl.trainer.dllm_main_ppo \
    ...
    # \
    # 2>&1 | tee ${log_dir}/${baseline}-${timestamp}.log
