...
from .rollout_utils import pack_sequences, align_pack_counts, execute_dream_generation
...
class DLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        responses, full_input_ids, attention_mask, answers = execute_dream_generation(
