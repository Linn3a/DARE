...
from .rollout_utils import pack_sequences, align_pack_counts, execute_cjdllm_generation
...
class DLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        for pack_idx, pack in enumerate(packs):
            batch_responses, batch_reversed_traj, batch_reversed_traj_unmask_positions, batch_full_input_ids, batch_attention_masks, batch_answers = execute_cjdllm_generation(
                pack=pack,
                module=self.module,
